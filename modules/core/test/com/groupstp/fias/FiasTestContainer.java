...
public class FiasTestContainer extends TestContainer {

    public FiasTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/groupstp/fias/app.properties",
    ...
    public static class Common extends FiasTestContainer {

        public static final FiasTestContainer.Common INSTANCE = new FiasTestContainer.Common();
